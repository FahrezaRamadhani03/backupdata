// <copyright file="IInvoiceDetailTaxRepository .cs" company="CV Garuda Infinity Kreasindo">
...
namespace Garuda.Modules.ProjectManagement.Models.Contracts
{
    ...
    /// </summary>
    public interface IInvoiceDetailTaxRepository : IRepository
    {
        /// <summary>
        ...
        Task AddOrUpdate(InvoiceDetailTax model);
