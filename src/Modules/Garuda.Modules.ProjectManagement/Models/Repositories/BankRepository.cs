// <copyright file="BankRepository.cs" company="CV Garuda Infinity Kreasindo">
...
namespace Garuda.Modules.ProjectManagement.Models.Repositories
{
    ...
    {
        public async Task AddOrUpdate(Bank model)
        {
        ...
        public async Task<Bank> GetData(Guid id)
        {
            var data = await this.dbSet.FirstOrDefaultAsync(x => x.Id == id);
            return data;
        }

        public async Task<List<Bank>> GetData()
        {
            var data = await this.dbSet.ToListAsync();
            return data;
        }

        public async Task<Bank> GetData(string name)
        {
