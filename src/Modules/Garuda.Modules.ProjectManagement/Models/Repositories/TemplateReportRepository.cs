// <copyright file="TemplateReportRepository.cs" company="CV Garuda Infinity Kreasindo">
...
{
    public class TemplateReportRepository : RepositoryBase<TemplateReport>, ITemplateReportRepository
    {
        public async Task AddOrUpdate(TemplateReport model)
        {
        ...
        public async Task<TemplateReport> GetData(Guid id)
        {
            var data = await this.dbSet.FirstOrDefaultAsync(x => x.Id == id);
            return data;
        }

        public async Task<List<TemplateReport>> GetData()
        {
            var data = await this.dbSet.ToListAsync();
            return data;
        }

        public async Task<TemplateReport> GetData(string subject)
        {
