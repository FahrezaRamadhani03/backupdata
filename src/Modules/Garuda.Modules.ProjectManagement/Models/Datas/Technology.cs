// <copyright file="Technologies.cs" company="CV Garuda Infinity Kreasindo">
...
{
    public class Technology : BaseModel, IEntity, IEntityRegister
    {
        /// <summary>
        ...
        public void RegisterEntities(ModelBuilder modelbuilder)
        {
            modelbuilder.Entity<Technology>(entity =>
            {
                ...
                entity.HasData(TechnologySeeder.Seed());
            });
        }
    }
}
